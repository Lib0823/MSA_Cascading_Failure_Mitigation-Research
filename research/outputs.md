...
| 관련연구 5자 비교표 (GRAF/FIRM/DeepScaler/AGQ/GraphGRU) + 3분할 구조 | [docs/proposal.md](../docs/proposal.md) §3 | 완성 |
...
| 외부 피드백 검토 기록 | [docs/feedback/](../docs/feedback/) | 3건 (0802 최적화 / 0906 설계이슈 선별 / 0906 LLM 확장) |
...
- **코드** — GNN 예측 레이어, Policy Engine, Actuator 통합 구현 (`code/model`, `code/backend`, `code/simulator`, `code/utils`)
- **실험 데이터/결과** — Online Boutique + Spring/Postgres + LLM 노드 확장 구성(13~14노드) 위 실측 데이터 및 baseline 비교 결과 (`data/raw`, `data/processed`, `data/sample`)
